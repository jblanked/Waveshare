...
void setup()
{
    ...
    lcd_draw_text(twenty_x * 5, twenty_y * 13, "RP2350 Touch LCD Demo", COLOR_WHITE);
...
void loop()
{
    ...
    lcd_draw_text((uint16_t)(twenty_x * 4.5), (uint16_t)(twenty_y * 6), acc_text, COLOR_WHITE);
    lcd_draw_text((uint16_t)(twenty_x * 4.5), (uint16_t)(twenty_y * 18), gyro_text, COLOR_WHITE);
